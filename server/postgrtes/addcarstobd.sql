...
-- SELECT Cars.brand, Cars.model, Cars.Engine, Transmission.Transmission, Fuel.Fuel  FROM Cars INNER JOIN transmission ON Transmission.Id_T=Cars.transmission INNER JOIN Fuel ON Fuel.Id_F=Cars.Fuel;
