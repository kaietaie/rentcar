...
CREATE TABLE Clima (
    ...
    Clima integer REFERENCES Boolen(Id_B) NOT NULL
);
CREATE TABLE Fuel (
...
CREATE TABLE Cruise (
    ...
    Cruise integer REFERENCES Boolen(Id_B) NOT NULL
);
CREATE TABLE Class (
...
CREATE TABLE Available (
    ...
    Available integer REFERENCES Boolen(Id_B) NOT NULL
);
CREATE TABLE Cars (
    ...
    Consumption     real,
    Trunk           integer,
    Class           varchar(32) REFERENCES Class(Id_C) NOT NULL,
    Seats           integer,
